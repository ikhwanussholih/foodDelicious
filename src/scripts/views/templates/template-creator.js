...
<div class="card">
    <img data-src="${restaurant.pictureId}" src="${restaurant.pictureId}" alt="${restaurant.name}">
    <div class="card-content">
        <h3><a href='/#/detail/${restaurant.id}'>${restaurant.name}</a></h3>
        <h4><i class="fa-solid fa-location-dot" style="color: #e00022;"><span>${restaurant.subdistrict}</span></i></h4>
        <h4><i class="fa-regular fa-clock"><span>${restaurant.time}</span></i></h4>
    </div>
</div>
`;

const createRestaurantDetailTemplate = (restaurant) => `
<img src="${restaurant.pictureId}" alt="${restaurant.name}" class="pictureId">
<h2 class="retaurant__Title">${restaurant.name}</h2>
<div class="restaurant__content">
    <h3 id="location"><i class="fa-solid fa-location-dot" style="color: #e00022;"><span>${restaurant.subdistrict}</span></i></h3>
    <p class="restaurant__content__address"><i class="fa-solid fa-clock">${restaurant.time}</i></p>
    <p class="restaurant__content__address">${restaurant.address}</p>
    <h3><span>Deskripsi Tempat</span></h3>
